...
if __name__=='__main__':
    ...
    if params.method in ['baseline', 'baseline++'] :
        ...
        if params.method == 'protonet':
            if params.adversarial:
                model = ProtoNet( model_dict[params.model], params.test_n_way, params.n_shot, backbone.Disc_model(
                    params.train_n_way), cosine=params.cosine)
            else:
    ...
    model = train(base_loader, val_loader,  model, optimization, start_epoch, stop_epoch, params, writer)
